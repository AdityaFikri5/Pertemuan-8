package id.ac.poliban.mi.adit.homework_045;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(a.layout.activity_main);
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Recyler View_025");

        readFile(getResources().openRawResource(a.raw.recipe_names), mRecipeNames);
        readFile(getResources().openRawResource(a.raw.recipe_desc), mRecipeDesc);
        RecyclerView mRecyclerView = findViewById(a.id.recycler_view);
